...
public:
  ...
  static uint8_t serverip[4]; // next-server (from DHCP)
  ...
  static void sendArpRequest (uint8_t *ip);
  static void setServerMAC();
  // new stash-based API
  ...
  static bool is_myIp(uint16_t len);
  static byte serverMacKnown();
